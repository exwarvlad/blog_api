...
%x(curl -v -H "Accept: application/json" -H "Content-type: application/json" -X POST -d ' {"post": {"header":"x-fa-fafds","body":"yoyoy42", "ip":"127.0.0.1", "user_login": "ttt424242"}}'  http://localhost:3000/posts)
